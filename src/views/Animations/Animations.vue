    ...
    <div class="cards">
      <div class="card">
        ...
        <div class="card__content">
          <p class="card__body">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          <div class="heart">
...
.animations {
  .animation {
    ...
    .box {
      ...
      transition: width 1000ms ease-in, height 1000ms ease-in;
  ...
  *::after {
  ...
  .card__header {
    ...
    display: flex;
    transition: top 300ms ease-out, left 300ms ease-out, bottom 300ms ease-out, right 300ms ease-out;
